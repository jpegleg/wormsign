...
/// The secret key for the secret key (AES256 key) is generated using password input as key material
/// generated by Argon2 hashing with a fixed salt. See the aesrest module (aesrest.rs) for more related
/// to this private key protection cryptogaphy.
...
fn version() -> Result<(), Box<dyn StdError>> {
    println!("wormsign version 0.1.6\n");
    Ok(())
}
